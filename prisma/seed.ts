...
async function main() {
  ...
  const dummySurveys = [
    ...
    },
    {
      ...
      stageReached: "Enquête foncière",
      dossierId: "DOS-2024-002",
      depositCity: "Lambaréné",
      regularizationCity: "Lambaréné",
      residenceCity: "Lambaréné",
      userType: "Personne physique",
      legalEntity: "Personne physique",
      nationality: "Gabonaise",
      depotEvaluation: "5",
    ...
    },
    {
      ...
      affichageInformationChannel: "Téléphone",
    ...
    },
    {
      ...
      stageReached: "Rapport d'évaluation",
      ...
      bornagePaymentMode: "Espèces",
      bornageHasReceipt: true,
      bornageSatisfaction: "5",
      evaluationPriceUnderstanding: "Totalement d'accord",
    ...
    },
    {
      ...
      evaluationPriceUnderstanding: "D'accord",
      evaluationPaymentMode: "Virement bancaire",
      evaluationHasReceipt: true,
    ...
    },
    {
      ...
      bornageHasReceipt: true,
      bornageSatisfaction: "3",
      evaluationPriceUnderstanding: "Neutre",
      evaluationPaymentMode: "Espèces",
      evaluationHasReceipt: true,
    ...
    },
    {
      ...
      affichageSatisfaction: "4",
      bornageDelayPerceived: "3-6 mois",
      bornagePaymentMode: "Chèque",
      bornageHasReceipt: true,
      bornageSatisfaction: "4",
      evaluationPriceUnderstanding: "D'accord",
      evaluationPaymentMode: "Chèque",
      evaluationHasReceipt: true,
      evaluationSatisfaction: "4",
      decisionDelay: "6-12 mois",
      decisionPaymentMode: "Chèque",
      decisionHasReceipt: true,
      wasTransmitted: true,
      hasActeCession: true,
      hasTitrePropriete: false,
  ...
  console.log(`✅ Created ${dummySurveys.length} dummy surveys`);

  // Verify survey distribution
  console.log("\n📊 Surveys by city:");
  for (const city of ["Libreville", "Lambaréné", "Mouila"]) {
