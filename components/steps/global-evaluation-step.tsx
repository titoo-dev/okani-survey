...
export function GlobalEvaluationStep({
  formData,
  updateFormData,
}: GlobalEvaluationStepProps) {
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <Label htmlFor="transmissionDate">
          Date de transmission à la Conservation foncière (optionnel)
        </Label>
        <Input
          id="transmissionDate"
          type="date"
        ...
        <p className="text-sm text-muted-foreground">
          Date à laquelle votre dossier a été transmis à la Conservation
          foncière
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          onChange={(e) =>
            updateFormData({ generalSuggestions: e.target.value })
          }
          rows={6}
          maxLength={1000}
        />
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-sm">
            ...
            <p className="text-muted-foreground">
              Vos retours sont précieux et contribueront à l'amélioration
              continue des services fonciers.
            </p>
          </div>
        </div>
      </div>
...
export function validateGlobalEvaluationStep(
  formData: Pick<
    ...
    "totalDelay" | "transmissionDate" | "totalCost" | "globalSatisfaction"
  >,
): boolean {
