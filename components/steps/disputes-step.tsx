...
export function DisputesStep({ formData, updateFormData }: DisputesStepProps) {
  return (
    <div className="space-y-6">
      ...
      {formData.hadOpposition === "oui" && (
        <>
          ...
          <div className="space-y-2">
            ...
            <Select value={formData.oppositionNature} onValueChange={(value) => updateFormData({ oppositionNature: value })}>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <RadioGroup value={formData.paidLitigeFees} onValueChange={(value) => updateFormData({ paidLitigeFees: value })}>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="oui" id="paid-fees-yes" />
                <Label htmlFor="paid-fees-yes" className="font-normal cursor-pointer">Oui</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="non" id="paid-fees-no" />
                <Label htmlFor="paid-fees-no" className="font-normal cursor-pointer">Non</Label>
              </div>
            </RadioGroup>
          </div>

          {formData.paidLitigeFees === "oui" && (
            <>
              <div className="space-y-2">
                <Label>Mode de paiement*</Label>
                <Select value={formData.litigePaymentMode} onValueChange={(value) => updateFormData({ litigePaymentMode: value })}>
                  <SelectTrigger>
              ...
              <div className="space-y-2">
                ...
                <RadioGroup value={formData.litigeHasReceipt} onValueChange={(value) => updateFormData({ litigeHasReceipt: value })}>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="oui" id="litige-receipt-yes" />
                    <Label htmlFor="litige-receipt-yes" className="font-normal cursor-pointer">Oui</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="non" id="litige-receipt-no" />
          ...
          <div className="space-y-2">
            ...
            <RadioGroup value={formData.wasInformedProcedure} onValueChange={(value) => updateFormData({ wasInformedProcedure: value })}>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="oui" id="informed-procedure-yes" />
                <Label htmlFor="informed-procedure-yes" className="font-normal cursor-pointer">Oui</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="non" id="informed-procedure-no" />
          ...
          <div className="space-y-2">
            ...
            <RadioGroup value={formData.sentFormalLetter} onValueChange={(value) => updateFormData({ sentFormalLetter: value })}>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="oui" id="letter-yes" />
                <Label htmlFor="letter-yes" className="font-normal cursor-pointer">Oui</Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="non" id="letter-no" />
                <Label htmlFor="letter-no" className="font-normal cursor-pointer">Non</Label>
              </div>
            </RadioGroup>
          </div>

          {formData.sentFormalLetter === "oui" && (
            <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Select value={formData.litigeCause} onValueChange={(value) => updateFormData({ litigeCause: value })}>
              <SelectTrigger>
          ...
          <div className="space-y-2">
            ...
            <Select value={formData.litigeOutcome} onValueChange={(value) => updateFormData({ litigeOutcome: value })}>
              <SelectTrigger>
      ...
      {formData.hadOpposition === "non" && (
        <div className="bg-muted/50 rounded-lg p-6 text-center">
          <p className="text-muted-foreground">
            Aucune information supplémentaire n'est requise pour cette section.
          </p>
        </div>
      )}
    </div>
